...
import { getAllFaqCategories } from '../../App/Features/Faq/faqActions';
import { allFaqCategoriesSelector, allFaqCategoriesLoadingSelector, allFaqCategoriesErrorSelector } from './FaqCategory.Selector';
      ...
      <styled.div>
         ...
         <div className="container_div">
            <PageHeadingComponent
               ...
               Doloribus!`}
               menu={true}
               innerProps={<MenuItem onClick={() => navigation('/faq-category/create')}>Create new faq category</MenuItem>}
            />
            <div className="mt-2">
