...
function SingleTransactionInfoPage() {
   ...
   const updateFiatWithdrawLoading = useSelector(
      updateFiatWithdrawLoadingSelector
   );
   ...
   return (
      <div>
         <AnimatePresence>
            {ShowAnimation && <OrderCompletedPopUpComponent />}
         </AnimatePresence>
         <NavbarComponent />
                  ...
                  singleOrder?.transactions && (
                     <div className="result_cr_div">
                        ...
                        {singleOrder?.transactions?.upiRefNumber && (
                           <BoxCm
                              heading={'Upi Ref Number'}
                              value={singleOrder?.transactions?.upiRefNumber}
                           />
                        )}
