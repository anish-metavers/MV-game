      ...
      <styled.div>
         ...
         <div className="container_div">
            <PageHeadingComponent
               ...
               menu={true}
               innerProps={
                  <MenuItem onClick={CreateGameCurrencyHandler}>
                     Add new currency
                  </MenuItem>
               }
            />
            <styled.contentDiv className="mt-5">
               <div className="mt-5">
                  ...
                  {!!gameCurrencyListError ? (
                     <p className="text-sm error_cl">{gameCurrencyListError}</p>
                  ) : null}
                  {!!gameCurrencyListInfo &&
                  gameCurrencyListInfo?.success &&
                  gameCurrencyListInfo?.currency?.length ? (
                     <TableComponent
                        row={ROW}
                        ...
                        disableNextbtn={
                           +page >= gameCurrencyListInfo?.totalPages
                              ? true
                              : false
                        }
                     >
