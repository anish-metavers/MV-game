...
router.get(
   ...
   varifyJwtToken,
   gameController.getAllGameCategory
);
router.get(
   '/get-games-all-category',
   varifyJwtToken,
   gameController.getAllGamesCategroy
);
router.get(
   '/get-games-providers-lists',
   varifyJwtToken,
   gameController.getGameProvidersList
);
router.get(
   '/get-single-game-category',
   varifyJwtToken,
   gameController.getSinglegameCategory
);
...
router.delete(
   ...
   varifyJwtToken,
   gameController.deleteSingleGameCategory
);
